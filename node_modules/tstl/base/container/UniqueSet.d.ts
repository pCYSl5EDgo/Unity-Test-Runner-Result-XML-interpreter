 ...
 */
export declare abstract class UniqueSet<Key, Source extends UniqueSet<Key, Source, IteratorT, ReverseT>, IteratorT extends ISetIterator<Key, true, Source, IteratorT, ReverseT>, ReverseT extends ISetReverseIterator<Key, true, Source, IteratorT, ReverseT>> extends SetContainer<Key, true, Source, IteratorT, ReverseT> {
    /**
     * @inheritDoc
     */
