 ...
 */
export declare abstract class UniqueMap<Key, T, Source extends UniqueMap<Key, T, Source, Iterator, Reverse>, Iterator extends IMapIterator<Key, T, true, Source, Iterator, Reverse>, Reverse extends IMapReverseIterator<Key, T, true, Source, Iterator, Reverse>> extends MapContainer<Key, T, true, Source, Iterator, Reverse> {
    /**
     * @inheritDoc
     */
